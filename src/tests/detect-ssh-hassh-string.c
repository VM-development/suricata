 ...
 */
static int DetectSshHasshStringTest01(void) {
    Flow f;
    ...
    uint8_t sshbuf3[] = {0x00, 0x00, 0x05, 0x6c, 0x04, 0x14, 0x18, 0x70, 0xcb, 0xa4,
                         0xa3, 0xd4, 0xdc, 0x88, 0x6f, 0xfd, 0x76, 0x06, 0xcf, 0x36, 0x1b, 0xc6, 0x00, 0x00, 0x01, 0x0d,
                         0x00, 0x00, 0x05, 0x6c, 0x04, 0x14, 0x18, 0x70, 0xcb, 0xa4, 0xa3, 0xd4, 0xdc, 0x88, 0x6f, 0xfd,
    ...
    s = de_ctx->sig_list = SigInit(de_ctx, "alert ssh any any -> any any ("
                                           "msg:\"match SSH hash-string\"; hassh.string; content:\"none,zlib@openssh.com,zlib\"; "
                                           "sid:1;)");
    FAIL_IF(s == NULL);
...
static void DetectSshHasshStringRegisterTests(void)
{
    UtRegisterTest("DetectSshHasshStringTest01", DetectSshHasshStringTest01);
}
